...
public:
	...
	void printmode(int n,int TWC,int TDC, int nc,int vc, int sc, int t, int d, CargoLinkedList L);
	...
	void interactive(int trucksnumbet,int cargosnumber,int deliverc, int normalc, int specialc, int vipc, int time, int days, CargoLinkedList L);
